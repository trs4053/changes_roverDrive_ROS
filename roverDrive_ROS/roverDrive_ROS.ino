...
Motor right(PB12,PB13,PA0,PA1,PB6,PB7);
Motor left(PB14,PB15,PA4,PA5,PB3,PB4);
...
std_msgs::Int16 leftWheel, rightWheel;
ros::Publisher lwheel_pub("lwheel", &leftWheel); 
ros::Publisher rwheel_pub("rwheel", &rightWheel); 
...
//  nh.loginfo("Publishing odometry");
  leftWheel.data = 10;
  lwheel_pub.publish(&leftWheel);
  rightWheel.data = 10;
  rwheel_pub.publish(&rightWheel);
}
